do_install_ubuntu_studio() {
	if (whiptail --title "Install a Desktop Environment" --yesno "You are about to install the Ubuntu Studio desktop. Are you sure?" 8 78) then {
